...
class News(Base): 
    ...
    title = Column(String(50), unique=False, index=True)
    date = Column(String(50), unique=False, index=True)
    url = Column(String(50), unique=False, index=True)
    media_outlet = Column(String(50), unique=False, index=True)
